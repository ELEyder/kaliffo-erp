...
const Trabajadores_main = () =>{
    ...
    const [ModalIncidenciasAbierto,setModalIncidenciasAbierto] = useState(false)
    ...
    return(
        <Plantilla>
            ...
            Refrescar={Refrescar} editar={showModalEditar}
            incidencias={showModalIncidencias} eliminar={eliminar}/>
