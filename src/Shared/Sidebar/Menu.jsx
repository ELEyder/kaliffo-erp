    ...
    children: [
      {
        ...
        icon: <BookOutlined />,
        children: [
          { key: "ventas-generar-boleta", icon: <BookOutlined />, label: <Link to="/gVenta/boleta">Boleta</Link> },
          { key: "ventas-generar-factura", icon: <BookOutlined />, label: <Link to="/gVenta/factura">Factura</Link> },
        ],
      },
